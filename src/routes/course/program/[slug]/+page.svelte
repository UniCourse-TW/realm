...
<section
	class="flex h-full w-full flex-col items-center justify-start gap-2 px-1 pt-4 sm:gap-4 sm:p-4 md:p-8"
>
	<div
	...
	>
		<h1 class="mb-2 text-xl font-bold md:text-3xl">{data.props.name}</h1>
	</div>
